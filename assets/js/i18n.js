...
(function (global) {
  ...
  var TRANSLATIONS = {
    fr: {
      ...
      visitUs: { heroTitle: 'Directions & Accessibilité', heroSubtitle: "Tout ce dont vous avez besoin pour arriver confortablement — en voiture, en métro ou à pied.", locationTitle: 'Notre Emplacement', metroJeanTalonTitle: 'En métro ?', metroJeanTalonDesc: 'À quelques minutes à pied de la station Jean-Talon.', metroCastelnauTitle: 'En métro ?', metroCastelnauDesc: 'À deux pas de Skines Med Spa & Wellness.', parkingTitle: 'En voiture ?', parkingDesc: 'Un espace gratuit réservé exclusivement pour vous.', helpTitle: 'Besoin d\'aide ?', helpDesc: "Appelez-nous à votre arrivée et nous vous guiderons avec plaisir.", openMaps: 'Ouvrir dans Google Maps', copyAddress: "Copier l'adresse", copied: 'Copié ✓', callUs: 'Appeler Skines' },
